	...
	CLITopics = append(CLITopics, Topics{
		{
			...
			Commands: Commands{
				...
				},
				{
					...
					Flags: []Flag{
						{Name: "dir", Char: "d", Required: truePointer, HasValue: true},
						{Name: "version", Char: "v", Required: truePointer, HasValue: true},
						{Name: "channel", Char: "c", Required: truePointer, HasValue: true},
						{Name: "targets", Char: "t", Required: truePointer, HasValue: true},
					},
					Run: buildManifest,
				},
				{
					...
					Flags: []Flag{
						{Name: "new", HasValue: true, Required: truePointer},
						{Name: "channel", HasValue: true, Required: truePointer},
						{Name: "target", HasValue: true, Required: truePointer},
						{Name: "out", HasValue: true, Required: truePointer},
					},
					Run: buildBsdiff,
				},
			},
